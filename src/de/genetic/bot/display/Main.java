...
public class Main {
    public static void main(String[] args) {
        ...
        String path = "C:\\Users\\Thomas\\Documents\\IntelliJ\\genetic-algorithm\\src\\demo\\";
        Path initPath = Paths.get(path, "initData\\init.sim");
        Path inPath = Paths.get(path, "inputData\\player.simin");
        Path outPath = Paths.get(path, "outData\\state.simout");
    ...
    static RandomBot bot = new RandomBot(2500, 2500, 42);

    static void loop(Simulation sim, PrintWriter out) {
